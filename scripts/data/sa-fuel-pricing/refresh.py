...
RAW = ROOT / 'data/raw/sa-fuel-pricing'
PUBLIC = ROOT / 'data/processed/sa-fuel-pricing/browser-preview'
COUNTRY = 21
...
def main() -> int:
    ...
    metadata = {'project': 'pulse-of-adelaide', 'datasetVersion': 1, 'generatedAt': retrieved,
                ...
                'processing': {'script': 'scripts/data/sa-fuel-pricing/refresh.py',
    ...
    print('Private data only: output remains in ignored data/processed/sa-fuel-pricing/browser-preview/.')
    return 0
